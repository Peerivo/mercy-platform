...
- Local lint (no errors, two existing warnings), typecheck, 7 unit tests and build are VERIFIED on 2026-09-13 after the Realtime readiness fixes. The local runtime was Node 20 rather than the required CI Node 22; Docker-backed checks remain NOT_RUN for the new head and CI coverage is not weakened.

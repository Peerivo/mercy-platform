...
4. Take and retain a safety backup of the fresh Beget target using a custom-format `pg_dump --create`, globals backup, and a server-side fingerprint of database owner/ACL/settings; the archive must contain database creation metadata.

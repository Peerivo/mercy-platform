...
export default async function RequestsPage({
  ...
  // Берём на одну запись больше,
  // чтобы понять, нужна ли кнопка "Далее".
  const { data, error } = await s.rpc(
    "list_public_help_requests",
    {
      category_filter:
    ...
    <section className="page-shell section">
      <div className="nav">
        <div>
          ...
          <p className="muted">
            Здесь опубликованы просьбы
            людей, которым сейчас нужна
            помощь.
          </p>
        </div>
